...
lectures = [
  { title: 'El Círculo de Quintas', image: 'circulo_quintas.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274469/acordes_escalas_pirhmg.mp4', video: 'acordes_escalas.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: 'Cómo leer partituras: El Endecagrama Primigenio', image: 'leer_partituras.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710273852/leer_partituras_gwbvbr.mp4' , video: 'leer_partituras.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: '¿Por qué medimos el ritmo así?', image: 'ritmo.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272553/ritmo_zjofkm.mp4' , video: 'ritmo.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: '¿Qué es un acorde?. Tipos de Acordes', image: 'acordes.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272518/acordes_ha9d1n.mp4' , video: 'acordes.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: '¿Qué es una escala musical?', image: 'escala.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272171/escala_e8otqu.mp4' , video: 'escala.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: '¿Qué es un intervalo musical?', image: 'intervalo.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272508/intervalo_tmf1lw.mp4' , video: 'intervalo.mp4',  published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: '¿Qué son las tonalidades?', image: 'tonalidades.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710273613/tonalidades_pfxco9.mp4' , video: 'tonalidades.mp4', published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
  { title: 'Piano Básico', image: 'piano_basico.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272310/piano_basico_tz89fa.mp4' , video: 'piano_partituras.mp4', published: true, course_id: Course.where('title = ?', "Aprende a tocar el piano con mi curso de Piano Básico").first.id },
  { title: 'Piano Melodías', image: 'piano_melodias.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274533/piano_melodias_l8hogu.mp4' , video: 'piano_melodias.mp4', published: true, course_id: Course.where('title = ?', "Aprende a tocar el piano con mi curso de Piano Básico").first.id },
  { title: 'Piano Partituras', image: 'piano_partituras.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710275543/piano_partituras_gzlft7.mp4' , video: 'piano_partituras.mp4', published: true, course_id: Course.where('title = ?', "Aprende a tocar el piano con mi curso de Piano Básico").first.id },
  { title: 'Piano Acompañamientos', image: 'piano_acompañamientos.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710272151/piano_acompa%C3%B1amientos_lxxrdn.mp4' , video: 'piano_partituras.mp4', published: true, course_id: Course.where('title = ?', "Aprende a tocar el piano con mi curso de Piano Básico").first.id },
  { title: 'Lección 1', image: 'canto_1.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274026/canto_1_a4zjp2.mp4', video: 'canto_1.mp4', published: true, course_id: Course.where('title = ?', "Cantar desde Cero para Principiantes").first.id },
  { title: 'Lección 2', image: 'canto_2.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274681/canto_2_h3urgw.mp4' , video: 'canto_2.mp4', published: true, course_id: Course.where('title = ?', "Cantar desde Cero para Principiantes").first.id },
  { title: 'Lección 3', image: 'canto_3.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274228/canto_3_hjjczn.mp4' , video: 'canto_3.mp4', published: true, course_id: Course.where('title = ?', "Cantar desde Cero para Principiantes").first.id },
  { title: 'Lección 4', image: 'canto_4.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274689/canto_4_e89nn1.mp4' , video: 'canto_4.mp4', published: true, course_id: Course.where('title = ?', "Cantar desde Cero para Principiantes").first.id },
  { title: 'Lección 5', image: 'canto_5.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710273458/canto_5_e4rabh.mp4' , video: 'canto_5.mp4', published: true, course_id: Course.where('title = ?', "Cantar desde Cero para Principiantes").first.id },
  { title: 'Lección 1: Posición', image: 'guitarra_1.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710273752/guitarra_1_plnopb.mp4' , video: 'guitarra_1.mp4', published: true, course_id: Course.where('title = ?', "Guitarra para principiantes").first.id },
  { title: 'Lección 2: Cambio de cuerdas y afinación', image: 'guitarra_2.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274613/guitarra_2_efcirc.mp4' , video: 'guitarra_2.mp4', published: true, course_id: Course.where('title = ?', "Guitarra para principiantes").first.id },
  { title: 'Clase para Principiantes #1', image: 'bateria_1.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274936/bateria_1_oxqyhj.mp4' , video: 'bateria_1.mp4', published: true, course_id: Course.where('title = ?', "Batería desde 0: Primeros Pasos, Curso Intensivo").first.id },
  { title: 'Remates - Clase para Principiantes #2', image: 'bateria_2.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274906/bateria_2_tcql9t.mp4' , video: 'bateria_2.mp4', published: true, course_id: Course.where('title = ?', "Batería desde 0: Primeros Pasos, Curso Intensivo").first.id },
  { title: 'Como Usar La Púa', image: 'electrica_1.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274255/electrica_1_tlygnh.mp4' , video: 'electrica_1.mp4', published: true, course_id: Course.where('title = ?', "Aprende a tocar el piano con mi curso de Piano Básico").first.id },
  { title: 'Ejercicios de digitación', image: 'electrica_2.jpg', video_url: 'https://res.cloudinary.com/dc6zpqwln/video/upload/v1710274342/electrica_2_jipg2x.mp4' , video: 'electrica_2.mp4', published: true, course_id: Course.where('title = ?', "Como tocar guitarra eléctrica").first.id },
]
