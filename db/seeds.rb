...
lectures = [
  ...
  { title: '¿Qué es un intervalo musical?', image: 'intervalo.jpg', video_url: 'https://res.cloudinary.com/dgz3yly6v/video/upload/v1710171437/development/v4z71i05di09m3wlcjuf79dwvsf0.mp4' , video: 'intervalo.mp4',  published: true, course_id: Course.where('title = ?', "Teoría Musical. Conceptos Básicos. Tutoriales").first.id },
...
contents = {
  ...
  '¿Qué es un intervalo musical?' => '<p>Un intervalo musical es la distancia entre dos notas musicales diferentes. Es una medida de la relación de altura entre las notas y es fundamental en la teoría musical y en la construcción de acordes y melodías.</p>
                                ...
                                <li>Octava perfecta: La distancia entre Do y Do una octava más arriba o más abajo.</li>
  ...
  'Lección 1' => '<p>¿A quién no le gustaría cantar bien y tener ese recurso tan magnífico para lucir su voz cuando quiera y donde quiera? Lo cierto es que aprender a cantar es un viaje que será diferente para cada quién, dado que tu voz es un instrumento único y tu fisionomía tiene capacidades que otros quizás no tengan. Además, dependiendo de tus metas individuales y estilo de aprendizaje verás que cantar es proceso que se puede ir mejorando con la práctica y el tiempo.<p>
                  ...
                  <ul><ol>Entender Tu Voz: Tu voz es única y puede tener un rango específico. El rango vocal se refiere a todas las notas que puedes cantar, desde la más baja hasta la más alta. Los rangos vocales suelen clasificarse en categorías como soprano, mezzosoprano, contralto, tenor, barítono y bajo</ol><ol>Respiración y Apoyo: Cantar es un acto físico y requiere que aprendas a controlar tu respiración. Deberías aprender a respirar desde el diafragma, cosa que hacías perfecto cuando eras un bebe. Además esto te dará más control y te permitirá sostener notas durante más tiempo y uniformemente. El «apoyo» es la idea de usar la potencia de tu respiración para cantar de manera más eficaz.</ol><ol>Afinación: La afinación se refiere a la capacidad de cantar en tono, es decir, acertar las notas exactas en la música. Cantar desafinado es cantar demasiado alto (agudo) o demasiado bajo (grave) en comparación con la melodía deseada.
                  Una buena afinación es fundamental para un canto efectivo. la mayoría de personas tienen la capacidad de distinguir los tonos, por lo que no será difícil para tí encontrar la diferencia entre dos notas en cuanto sepas identificar qué es agudo y qué es grave.</ol><ol>Control del Volumen: La dinámica en la música se refiere a lo fuerte o suave que es el sonido. En el canto, necesitas aprender a controlar tu volumen para que puedas cantar suave o fuerte cuando sea necesario en la canción, eso sí sin que se escuche forzado o haciéndole daño a tu voz.</ol><ol>Tono: El tono se refiere al color o la calidad de tu voz. Puede ser cálido, oscuro, brillante, ligero, pesado, etc. Cada cantante tiene un tono único que puede ser trabajado y mejorado con la práctica y la técnica.</ol><ol>Articulación: La articulación es la claridad de la pronunciación y la enunciación. Es importante que el público entienda las palabras que estás cantando. La articulación también puede afectar el ritmo de la canción.</ol><ol>Resonancia: La resonancia es el proceso de amplificación y enriquecimiento del sonido de tu voz. Cuando cantas, el sonido de tu voz resuena (o vibra) en diferentes partes de tu cuerpo como la garganta, la boca y la nariz. Un buen canto utiliza eficazmente estas áreas de resonancia para producir un sonido completo y rico.</ol><ol>Registro Vocal: El registro vocal se refiere a las diferentes «áreas» de la voz que se utilizan para producir sonido, que suelen clasificarse en pecho, cabeza y falsete. El registro de pecho es la voz más baja y más rica, el registro de cabeza es más alto y más brillante, y el falsete es un registro aún más alto.</ol></ul>',
